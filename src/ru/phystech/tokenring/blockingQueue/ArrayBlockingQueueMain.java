...
public class ArrayBlockingQueueMain {
    ...
    private static void testTokenRing(int nodesAmount, int dataAmount, long[][] resLatencies, long[][] resThroughputs) {
        ...
        for (int i = 0; i < 10; i++) {
            ArrayBlockingQueueRingProcessor processor = new ArrayBlockingQueueRingProcessor(nodesAmount, dataAmount, new File("logPath"));
    ...
    private static void warmup() {
        ArrayBlockingQueueRingProcessor processor = new ArrayBlockingQueueRingProcessor(5, 5, new File("logPath"));
        processor.startProcessing();
