...
public class ConcurrentLinkedQueueMain {
    ...
    private static void testTokenRing(int nodesAmount, int dataAmount, long[][] resLatencies, long[][] resThroughputs) {
        ...
        for (int i = 0; i < 10; i++) {
            ConcurrentLinkedQueueProcessor processor = new ConcurrentLinkedQueueProcessor(nodesAmount, dataAmount, new File("logPath"));
    ...
    private static void warmup() {
        ConcurrentLinkedQueueProcessor processor = new ConcurrentLinkedQueueProcessor(5, 5, new File("logPath"));
        processor.startProcessing();
