...
public class VolatileMain {
    ...
    private static void testTokenRing(int nodesAmount, int dataAmount, long[][] resLatencies, long[][] resThroughputs) {
        ...
        for (int i = 0; i < 10; i++) {
            VolatileProcessor processor = new VolatileProcessor(nodesAmount, dataAmount, new File("logPath"));
    ...
    private static void warmup() {
        VolatileProcessor processor = new VolatileProcessor(5, 5, new File("logPath"));
        processor.startProcessing();
